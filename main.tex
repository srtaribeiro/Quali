...
\titlegraphic{
\includegraphics[height=1cm]{figures/lscadlogo.png}
\hspace{1.5cm}
\includegraphics[height=1cm]{figures/cec.jpg}
\hspace{1cm}
\includegraphics[height=1.25cm]{figures/ufms_logo.png}
\hspace{1cm}
\includegraphics[height=1.25cm]{figures/cem.jpg}
\hspace{1cm}
\includegraphics[height=1.25cm]{figures/cep.jpg}
}
...
\logo{\includegraphics[height=1cm]{figures/lscadlogo.png}}
